...
function SchemaList() {
  ...
  const [schemas, setSchemas] = useState([]);
    const [brokeBoi, setBrokeBoi] = useState(false);
  ...
  if (!brokeBoi) {
      ...
      return(
        <p style={{marginLeft:10,marginRight:10,marginTop:50}}>We couldn't find any funding for your dataset, to access your data, you first need to fund your dataset. This can be done with USDC or you can get free funding tokens by sending us a DM on <a target={ "_blank"} href={"https://twitter.com/Kwil_App?s=20&t=vGMnTqHKwwv9NvXXX8Lguw"}> Twitter</a> </p>
      );
  }
}
