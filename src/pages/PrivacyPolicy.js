export default function PrivacyPolicy() {
  return (
    ...
    >
      <h1>Privacy Policy for Kwil, Inc.</h1>

      <p>
        At Kwil, accessible from https://db.kwil.com, one of our main priorities
        is the privacy of our visitors. This Privacy Policy document contains
        types of information that is collected and recorded by KwilDB and how we
        use it.
      </p>
      ...
      <p>
        ...
        share and/or collect in KwilDB. This policy is not applicable to any
      ...
      <p>
        KwilDB follows a standard procedure of using log files. These files log
      ...
      <p>
        Like any other website, KwilDB uses 'cookies'. These cookies are used to
      ...
      <p>
        Kwil's Privacy Policy does not apply to other advertisers or websites.
      ...
      <p>
        Kwil does not knowingly collect any Personal Identifiable Information
