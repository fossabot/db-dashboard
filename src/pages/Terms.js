export default function Terms() {
  return (
    ...
    >
      ...
      <p>Welcome to KwilDB!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of Kwil, Inc.'s Website, located at https://db.kwil.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use KwilDB if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing KwilDB, you agreed to use
        cookies in agreement with the Kwil, Inc.'s Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Kwil, Inc. and/or its licensors own the
        intellectual property rights for all material on KwilB. All intellectual
        property rights are reserved. You may access this from Kwil for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from Kwil</li>
        <li>Sell, rent or sub-license material from Kwil</li>
        <li>Reproduce, duplicate or copy material from Kwil</li>
        <li>Redistribute content from Kwil</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Kwil,
        ...
        of Kwil, Inc.,its agents and/or affiliates. Comments reflect the views
        and opinions of the person who post their views and opinions. To the
        extent permitted by applicable laws, Kwil, Inc. shall not be liable for
      ...
      <p>
        Kwil, Inc. reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Kwil, Inc. a non-exclusive license to use, reproduce,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Kwil, Inc.; and (d) the link is
      ...
      <p>
        ...
        e-mail to Kwil, Inc.. Please include your name, your organization name,
      ...
      <p>
        No use of Kwil, Inc.'s logo or other artwork will be allowed for linking
